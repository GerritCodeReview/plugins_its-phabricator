...
public class ConduitTest extends LoggingMockingTestCase {
  ...
  public void testManiphestSearchFailRelevant() throws Exception {
    ...
    Map<String, Object> paramsRelevant = new HashMap<>();
    Map<String, Object> paramsRelevant2 = paramsCaptureRelevant.getValue();
    paramsRelevant.put("constraints", paramsRelevant2.get("ids"));
    assertEquals("Task id is not set", 42, paramsRelevant);
  }
