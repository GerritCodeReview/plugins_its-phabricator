...
public class PhabricatorItsFacade implements ItsFacade {
  ...
  public static final String PROJECT_ACTION_ADD = "projects.add";
  public static final String PROJECT_ACTION_REMOVE = "projects.remove";
        ...
        case "remove-project":
          if (chopped.length == 2) {
            try {
              ...
              conduit.maniphestUpdate(taskId, projectPhids, PROJECT_ACTION_REMOVE);
            } catch (ConduitException e) {
              throw new IOException("Error on conduit", e);
            }
          } else {
